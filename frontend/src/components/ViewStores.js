                    ...
                    <tbody>
                        {
                            ...
                            <button type="button" className="btn btn-outline-danger"onClick={()=>deleteHandler(store.storeId)} >Delete</button>*/}
                                    <button type="button"  style={{color:"#8a1253",borderColor:"#8a1253"}} className="btn btn-light"onClick={()=>pizzaManager(store.storeId)} >Manage Pizzas</button>
                                    </div>
                                    </td>
                                </tr>
                            )
