                    ...
                    <tbody>
                        {
                            ...
                            return(
                                <tr key={index}>
                                    ...
                                    <button type="button"  style={{color:"#8a1253",borderColor:"#8a1253"}} className="btn btn-light" onClick={()=>updateStore(store.storeId)}>Update</button>
